...
const RoutePath = ({systems, previewSize, shortestRoute, routeButton=true}) => {
  ...
  return (
    <List style={{
      ...
      { routeButton &&
        <ListItemButtonLink
          href={`http://evemaps.dotlan.net/route/${ !shortestRoute ? '2:' : ''}${routeOrigin.name}:${routeDestination.name}`}
