...
//export const redirectUri = 'http://localhost:8879#access_token=123' //dev
export const redirectUri = 'http://eve-daytripper.s3-website-us-east-1.amazonaws.com/latest/oauth.html' //prod
